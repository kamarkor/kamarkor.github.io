...
- Developed a RAG-based chatbot to support business users in retrieving relevant domain-specific information, using LLMs and vector search on AWS.
- Built a semantic search engine to assist customer advisors by suggesting contextually relevant content in order to improve response speed and consistency.
- Contributed to the development of text classification models on call transcriptions, combining deep learning approaches and rule-based (regex) methods depending on the use case.
- Led a customer feedback classification project, coordinating between tech and business teams.
- Participated in the evaluation and integration of speech-to-text and conversation analysis solutions.

## Education
- **Université Paris 1 Panthéon-Sorbonne** (Master of Science - Statistics, Data Science)
- **Universidad Carlos III de Madrid** (Erasmus Exchange)
- **Université Paris-Est Créteil** (Bachelor's Degree - Economics, Mathematics)
